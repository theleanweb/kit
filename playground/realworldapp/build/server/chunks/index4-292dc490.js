...
const Component = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Component$1, "Layout").$$render($$result, {}, {}, {
    default: () => {
      return `${validate_component(Component$2, "Header").$$render($$result, {}, {}, {})} <div class="auth-page"><div class="container page"><div class="row"><div class="col-md-6 offset-md-3 col-xs-12"><h1 class="text-xs-center">Sign in</h1> <p class="text-xs-center"><a href="/register">Need an account?</a></p> ${errors ? `${validate_component(Component$3, "AuthErrors").$$render($$result, { errors }, {}, {})}` : ``} <form method="post" action="/login">${validate_component(Component$4, "Field").$$render(
        $$result,
        {
          name: "email",
          type: "text",
...
//# sourceMappingURL=index4-292dc490.js.map
